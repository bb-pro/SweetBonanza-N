...
private extension MainGameVC {
    private func setupUI() {
        ...
        backgroundImageView.image = UIImage(named: "bg\(selectedBackground + 1)game")
        ...
        if let level = level {
            ...
            levelLabel.text = mealNames[level]
    ...
    func finishDrawing() {
        ...
        } else if level == 1 || level == 8 || level == 10 {
